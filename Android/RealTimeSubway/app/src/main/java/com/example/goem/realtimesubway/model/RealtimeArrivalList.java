...
public class RealtimeArrivalList {
    ...
    {
        return "ClassPojo [statnList = "+statnList+", statnFid = "+statnFid+", selectedCount = "+selectedCount+", btrainNo = "+btrainNo+", subwayList = "+subwayList+", statnTid = "+statnTid+", subwayId = "+subwayId+", totalCount = "+totalCount+", curPage = "+curPage+", statnNm = "+statnNm+", bstatnNm = "+bstatnNm+", recptnDt = "+recptnDt+", arvlCd = "+arvlCd+", trainCo = "+trainCo+", beginRow = "+beginRow+", bstatnId = "+bstatnId+", endRow = "+endRow+", barvlDt = "+barvlDt+", subwayHeading = "+subwayHeading+", btrainSttus = "+btrainSttus+", arvlMsg3 = "+arvlMsg3+", arvlMsg2 = "+arvlMsg2+", updnLine = "+updnLine+", trainLineNm = "+trainLineNm+", ordkey = "+ordkey+", rowNum = "+rowNum+", pageRow = "+pageRow+", statnId = "+statnId+", subwayNm = "+subwayNm+"]";
    }
}
